...
(8, 'System Informasi', 5000, 120000, 13000),
(9, 'Junior Programmer', 5000, 1000, 900),
(10, 'Cleaner', 10000, 50000, 9000);
...
INSERT INTO `karyawan` (`id`, `nik`, `nama_lengkap`, `handphone`, `email`, `tanggal_masuk`, `user_id`) VALUES
...
(1, 'admin', 'admin@mail.com', NULL, '$2y$12$PznSMIqXnypHUxjuSB1OGuQuBu4Ke4MkD.jizfo5uHZoVZ9uJNjSm', 'WRve684XMROxlAc2E3MIJBtON04cQ2ZG8EAt13aDgCHURNPUwkIbbAjjzHwc', '2025-05-27 05:39:55', '2025-06-03 04:38:03', 'ADMIN'),
(2, 'mynigga', 'niggamail@ngga.com', NULL, '$2y$12$b5fwigXCxTTbG6mqcURQsu3HPRVq3kN/n2GS.4/8o6.lspJf7hJQa', NULL, '2025-06-03 04:36:50', '2025-06-03 04:36:50', 'PEGAWAI');
...
--
-- Constraints for table `jabatan_karyawan`
--
ALTER TABLE `jabatan_karyawan`
  ADD CONSTRAINT `FK_jabatan` FOREIGN KEY (`jabatan_id`) REFERENCES `jabatan` (`id`),
