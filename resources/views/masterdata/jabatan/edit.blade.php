                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="nama_jabatan" placeholder="Manager Produksi"
                                    class="form-control"
                                    value="{{ isset($jabatan) ? $jabatan->nama_jabatan : old('nama_jabatan') }}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="number" name="tunjangan_jabatan" placeholder="Rp.0" class="form-control"
                                    value="{{ isset($jabatan) ? $jabatan->tunjangan_jabatan : old('tunjangan_jabatan') }}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="number" name="uang_makan_perhari" placeholder="Rp.0" class="form-control"
                                    value="{{ isset($jabatan) ? $jabatan->uang_makan_perhari : old('uang_makan_perhari') }}"
                                    required>
                            </div>
                        </div>
                    </div>
